...
parser.add_argument('--protein_language_model_embedding_dim', default=1536, type=int, help="Embedding dimension for protein language models: Ankh = 1536")
...
parser.add_argument('--run_device', default='cuda:0', type=str, help="Compute device (e.g., 'cpu', 'cuda:0', 'cuda:1')")
